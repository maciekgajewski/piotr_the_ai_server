...
| [Websocket Conversation Protocol](websocket-conversation-protocol.md) | Normative; approved 2026-07-19; implemented by T-004 | Read before changing websocket admission, JSON events, websocket clients, heartbeat, capacity, follow-up gating, or resource leases | Strict websocket adapter/messages, repository clients, required bounds, admission, gate/lease, and binding tests |
