...
| [Protocol Conformance Catalogue](protocol-conformance-catalogue.md) | Normative conformance plan; T-004 sections approved 2026-07-19 and T-005 sections approved 2026-07-20 | Read before implementing or reviewing protocol requirements and tests | Requirement-to-owner and requirement-to-evidence traceability |
...
| [T-005 Websocket Client UX and Protocol Redesign](tasks/T-005-websocket-client-ux-protocol-redesign.md) | Ready for implementation; normative client contract approved 2026-07-20; awaiting separate runtime authorization | Replaces duplicated repository websocket-client loops with one typed engine, a `prompt_toolkit` terminal presenter, strict client-side protocol validation, deterministic follow-up timing, and consistent UX/exit behavior. |
