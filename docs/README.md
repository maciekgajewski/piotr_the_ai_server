...
|---|---|---|---|
| [AI Server Conversation Bridge Protocol](ai-server-conversation-protocol.md) | Normative; approved 2026-07-19 | Read before changing conversation core, scoped interfaces, input supervision, Agent factories, or application Conversation shutdown | Planned `ai_server/conversations/`, AgentConversation implementations, lifecycle registry, and bridge conformance tests; current runtime still uses superseded legacy code pending T-004 cutover |
| [Websocket Conversation Protocol](websocket-conversation-protocol.md) | Normative; approved 2026-07-19 | Read before changing websocket admission, JSON events, websocket clients, heartbeat, capacity, follow-up gating, or resource leases | Planned websocket adapter/client/config migration and binding conformance tests |
...
| [Microphone-Conversation Mapping](microphone-conversation-mapping.md) | Normative; approved 2026-07-19 | Read before changing how accepted speech, follow-up, bounded rendering, termination, or re-arm crosses the microphone and bridge protocols | Planned voice InputSession/InputConversation adapter, manager migration, and mapping tests; Microphone Protocol remains normative |
...
| [T-004 Conversation Bridge Protocol Redesign](tasks/T-004-conversation-bridge-protocol-redesign.md) | Active implementation task | Defines the approved per-conversation bridge architecture and normative protocol suite. It is ready for implementation; implementation has not started. |
