...
def test_system_status_domain_agent_refuses_anonymous_user(tmp_path):
    ...
    result = asyncio.run(agent.run_task(agent_context(conversation_id="c1", attributes={"medium": "voice"}), _task("quick_check"), {}))
...
def test_system_status_domain_agent_calls_llm_for_green_reply(tmp_path):
    ...
    conversation = agent_context(conversation_id="c1", attributes={"medium": "voice", "user": "Krzysztof"})
...
def test_system_status_domain_agent_uses_fallback_model_for_ok_status(tmp_path):
    ...
    asyncio.run(agent.run_task(agent_context(conversation_id="c1", attributes={"medium": "voice", "user": "Krzysztof"}), _task("quick_check"), {}))
...
def test_system_status_domain_agent_uses_main_model_for_warning_status(tmp_path):
    ...
    asyncio.run(agent.run_task(agent_context(conversation_id="c1", attributes={"medium": "voice", "user": "Krzysztof"}), _task("summary"), {}))
...
def test_system_status_domain_agent_mentions_many_issue_offer_context(tmp_path):
    ...
    result = asyncio.run(agent.run_task(agent_context(conversation_id="c1", attributes={"medium": "voice", "user": "Krzysztof"}), _task("summary"), {}))
...
def test_system_status_domain_agent_falls_back_on_llm_failure(tmp_path):
    ...
    result = asyncio.run(agent.run_task(agent_context(conversation_id="c1", attributes={"medium": "voice", "user": "Krzysztof"}), _task("quick_check"), {}))
