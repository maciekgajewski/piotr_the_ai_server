...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("websocket:\n  port: nope", "websocket.port must be an integer"),
        ("websocket:\n  port: 0", "websocket.port must be between 1 and 65535"),
        ("websocket:\n  port: 2137\n  path: chat", "websocket.path must be a string starting with '/'"),
        ("log_level: noisy\nwebsocket:\n  port: 2137", "log_level must be one of"),
        ("log_level: 1\nwebsocket:\n  port: 2137", "log_level must be a string"),
    ],
)
